...
import { ArrowUp, Eraser, Mic, MicOff, Paperclip, Square } from 'lucide-react'
  ...
  return (
    <div className="flex items-center justify-between px-3 pb-3">
      <div className="flex items-center gap-2">
        ...
        />
        <ButtonWithTooltip label="Attach file (images, PDF, TXT, CSV, Excel)">
          <AppIconButton
            size="icon-sm"
            variant="ghost"
        ...
        {showClear && (
          <ButtonWithTooltip label="Clear conversation history">
            <AppButton
              ...
              onClick={onClear}
            >
              <Eraser className="mr-2 size-3.5" aria-hidden="true" />
      ...
      {isSending ? (
        <div className="flex items-center gap-2" role="status" aria-live="polite">
          ...
          <ButtonWithTooltip label="Stop generating">
            ...
            >
              <Square className="size-3.5" fill="currentColor" stroke="none" aria-hidden="true" />
            </AppIconButton>
          </ButtonWithTooltip>
        </div>
      ) : (
